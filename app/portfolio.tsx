...
function BlackSitePage({ project }: { project: (typeof projects)[number] }) {
  return <SiteShell activePath="/projects"><section className="project-hero"><img src={project.image} alt="Half-Life 2: Black Site" /><div className="project-hero-shade" /><div className="project-hero-copy"><span className="eyebrow">03 / HAMMER</span><h1>Half-Life 2:<br />Black Site</h1><p>A single-player escape level focused on cover-based combat, environmental puzzles, and a gradual transition from the Citadel to City 17.</p></div></section><div className="blacksite-page">
    ...
    <section className="blacksite-section blacksite-empty"><span className="eyebrow">GAMEPLAY DESCRIPTION</span></section><section className="blacksite-section blacksite-empty"><span className="eyebrow">GALLERY</span></section>
  </div></SiteShell>;
}
